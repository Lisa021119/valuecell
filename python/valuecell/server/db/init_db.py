"""Database initialization script for the InsightDesk (ENMGT 5400) server."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Initialize InsightDesk database")
    parser.add_argument(
        "--force",
        action="store_true",
    ...
    logger.info("InsightDesk database initialization")
    logger.info("=" * 50)
