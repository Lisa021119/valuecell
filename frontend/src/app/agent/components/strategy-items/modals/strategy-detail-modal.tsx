...
import { InsightDeskAgentPng } from "@/assets/png";
            ...
            <div className="grid gap-4 py-4">
              <div className="flex items-center gap-4">
                <Avatar className="size-16">
                  <AvatarImage
                    src={isLoggedin ? avatar : InsightDeskAgentPng}
                    alt={name}
                  />
                  <AvatarFallback>
                    {isLoggedin ? name[0] : t("product.nameShort")[0]}
                  </AvatarFallback>
                </Avatar>
                <h3 className="font-bold text-lg">
                  {isLoggedin ? name : t("product.name")}
                </h3>
